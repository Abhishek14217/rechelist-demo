...
const ContactForm = () => {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primaryOrange to-secondaryYellow">
        Send us a message
      </h2>
      ...
      <div className="flex flex-col gap-gapSmall mt-gap">
        ...
        <button
          ...
          className={`bg-gradient-to-r from-primaryOrange to-secondaryYellow text-white font-semibold py-3 px-6 rounded-full transition ${
